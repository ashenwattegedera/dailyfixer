...
<div class="container">
    <nav class="sub-nav">
        ...
        <button class="cart-button">
            <img src="../../assets/images/icons/shopping-cart.png" alt="Cart Icon" class="cart-icon-img">
        </button>
    </nav>
