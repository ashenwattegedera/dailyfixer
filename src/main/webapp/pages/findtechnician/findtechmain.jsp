...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/findtechmain.css">
</head>
<body>
<header>
    ...
    <div class="subnav">
        ...
        <a href="#" class="active">Find a Technician</a>
...
<div class="container">
    ...
    <div class="filters">
        ...
        <select id="specializationFilter">
            ...
            <option value="Roofing and Guttering">Roofing and Guttering</option>
            <option value="Painting and Wall repairs">Painting and Wall repairs</option>
            <option value="Furniture repair and Assembly">Furniture repair and Assembly</option>
        </select>
    ...
    <div class="technicians" id="technicianList">
        <div class="technician-card"
            ...
            <img src="../../assets/images/pictures/profile_tech.jpg" alt="Technician">
            <div class="technician-details">
                <h3>Alex Johnson <img src="../../assets/images/icons/verify.png" alt="verify"></h3>
                <p>Rating: 4.5 (20 reviews)</p>
                <p>Plumbing, Electrical</p>
                <button onclick="viewDetails('technician_alex.html')">View Details</button>
            </div>
        </div>
        ...
        <div class="technician-card"
            ...
            <img src="../../assets/images/pictures/profile_plumber.jpg" alt="Technician">
            <div class="technician-details">
                <h3>Michael Lee <img src="../../assets/images/icons/verify.png" alt="verify"></h3>
        ...
        <div class="technician-card"
            ...
            <img src="../../assets/images/pictures/Profile_elec.jpg" alt="Technician">
            <div class="technician-details">
                <h3>Sarah Kim <img src="../../assets/images/icons/verify.png" alt="verify"></h3>
        ...
        <div class="technician-card"
             ...
             data-availability="Today"
             data-servicearea="Colombo">
            <img src="../../assets/images/pictures/tech_profile.jpg" alt="Technician">
            <div class="technician-details">
                <h3>David Silva <img src="../../assets/images/icons/verify.png" alt="verify"></h3>
